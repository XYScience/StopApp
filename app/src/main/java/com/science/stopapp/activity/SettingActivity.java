...
public class SettingActivity extends BaseActivity {
    ...
    private void changeLauncherIcon(final TextView tvChangeLauncherIcon) {
        ...
        view.findViewById(R.id.tv_circle).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setComponentEnabled(tvChangeLauncherIcon, new ComponentName(SettingActivity.this, "com.science.stopapp.MainSquareIconActivity"),
                        new ComponentName(SettingActivity.this, "com.science.stopapp.MainCircleIconActivity"));
                dialog.dismiss();
            }
        });
        view.findViewById(R.id.tv_square).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setComponentEnabled(tvChangeLauncherIcon, new ComponentName(SettingActivity.this, "com.science.stopapp.MainCircleIconActivity"),
                        new ComponentName(SettingActivity.this, "com.science.stopapp.MainSquareIconActivity"));
                dialog.dismiss();
            }
        });
    }
